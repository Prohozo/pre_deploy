...
class gen_graph:
    ...
    def grh_BarChart(self, x, y, text=None,label_x = None, label_y = None,label_color = None, marker_color=[None,None],width = None , orientation='v', title=None, size_title=13, margin=[5, 5, 5, 5]):
        ...
        data = [
            go.Bar(
                ...
                #width = 0.025*l if l > 1 else 0.025 ,
    ...
    def grh_DonutChart(self, values, labels, title=None, size_title=13, margin = [5, 5, 5, 5],colors=None):
    ...
    def grh_Multi_Line(self, data, x, y, legend, label_x= None, label_y = None, label_color = None, title=None, size_title=13, color_discrete_map=None, margin = [5, 5, 5, 5]):
    ...
    def grh_StackedBarChart(self, data, x, y, color=None, label_x= None, label_y = None, legend_title = None, title=None, size_title=13, color_discrete_sequence=None,category_orders=None, hovertemplate=None, margin = [5, 5, 5, 5]):
        fig = px.bar(data, x=x, y=y, color=color,color_discrete_sequence=color_discrete_sequence,category_orders=category_orders)
