...
def gen_layout():
    ...
    ], className='col-sm-2 col-md-2 col-lg-2 mb-3')
...
@app_Potential.callback(
    ...
    Input('potential_by_time_date', 'clickData'),
    Input('potential_by_time_month', 'clickData'),
    Input('potential_by_time_quarter', 'clickData'),
    Input('potential_by_time_year', 'clickData'),
)
def update_date_filter(date_value, ac_date, ac_month, ac_quarter, ac_year):
    ctx = dash.callback_context
    label, value = GParams_Potential.Get_Value(ctx)
