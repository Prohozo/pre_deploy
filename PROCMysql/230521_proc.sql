...
-- Dumping database structure for fpms_uta
CREATE DATABASE IF NOT EXISTS `fpms_uta` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `fpms_uta`;

-- Dumping structure for procedure fpms_uta.dsa_sp_action_multiline
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_action_tron
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_ddl_dept
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_ddl_project
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_detail_DuAn_Bang
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_overview_DuAn
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_overview_DuAn_doing
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_overview_DuAn_suspended
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_overview_DuAn_wait
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_SoDuAn_dept
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_status_DuAn_tron
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_status_MucdoTT_DuAn_BANG
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_ThongKe_DuAn_BANG
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_Tiendo_duan
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_sp_TL_DuAn_dept
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_all
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_all_detail_assign
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_all_detail_finish
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_all_detail_open
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_ddl_all
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_ddl_dept
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_ddl_project
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_ddl_story
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_ddl_user
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_delay_detail
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_num_est_hour_bytime
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_num_hour_bytime
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_num_pri
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_num_task_byproject
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_num_task_bystory
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_num_task_bytime
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_total_delay_task
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_total_hour
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_task_total_task
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_ddl
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_dropdown_department
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_dropdown_project
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_dropdown_username
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_productivity_line
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_project_bar
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_project_table
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskdone_bar
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskdone_byopenedby
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskdone_byothers
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskdone_bytime_line
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskdone_detail_pie
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskdone_percentage
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskdone_total
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskopened_bar
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskopened_bytime_line
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_taskopened_total
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_total_bang
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_without_task
DELIMITER //
...
-- Dumping structure for procedure fpms_uta.dsa_user_without_task_
DELIMITER //
