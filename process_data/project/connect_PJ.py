...
class Data_DuAn(Connect_SQLServer):
    ...
    def GET_overview_DuAN(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_overview_DuAn ({0},{1},{2},{3},{4},{5})".format(*params) 
        cursor = self.Call_Procedure(proc)
        cols = ['value']
        return self.Convert_DataFrame(cursor, cols)
    ...
    def GET_status_duan_tron(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_status_DuAn_tron ({0}, {1}, {2},{3},{4},{5})".format(*params)
        cursor = self.Call_Procedure(proc)
        cols = ['LoaiHinh','tong']
        return self.Convert_DataFrame(cursor, cols)
    ...
    def GET_detail_duan_bang(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_detail_DuAn_Bang ({0}, {1}, {2},{3},{4},{5})".format(*params)
        cursor = self.Call_Procedure(proc)
    ...
    def GET_detail_trangthai_bang(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_ThongKe_DuAn_BANG ({0}, {1}, {2}, {3},{4},{5})".format(*params)
        cursor = self.Call_Procedure(proc)
        cols = ['name','LoaiHinh', 'SoNgay','PM', 'begin','end','SoNguoi','SoTask']
        data = self.Convert_DataFrame(cursor, cols)
        return data
    ...
    def GET_overview_DuAN_doing(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_overview_DuAn_doing ({0},{1},{2},{3},{4},{5})".format(*params)
        print(proc)
        cursor = self.Call_Procedure(proc)
        cols = ['value']
        return self.Convert_DataFrame(cursor, cols)
    ...
    def GET_overview_DuAN_wait(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_overview_DuAn_wait ({0},{1},{2},{3},{4},{5})".format(*params) 
        cursor = self.Call_Procedure(proc)
        cols = ['value']
        return self.Convert_DataFrame(cursor, cols)
    ...
    def GET_overview_DuAN_suspended(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_overview_DuAn_suspended ({0},{1},{2},{3},{4},{5})".format(*params) 
        cursor = self.Call_Procedure(proc)
        cols = ['value']
        return self.Convert_DataFrame(cursor, cols)
    ...
    def GET_DuAn_dept_bang(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_SoDuAn_dept ({0}, {1}, {2},{3},{4},{5})".format(*params)
        cursor = self.Call_Procedure(proc)
        cols = ['dept','SoDA']
        data = self.Convert_DataFrame(cursor, cols)
        return data
    ...
    def GET_TL_DA_dept(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_TL_DuAn_dept ({0}, {1}, {2}, {3},{4},{5})".format(*params)
        cursor = self.Call_Procedure(proc)
    ...
    def GET_Tiendo_duan_bang(self, params):
        ...
        params = self.convert_params(params)
        proc = "Call dsa_sp_Tiendo_duan ({0}, {1}, {2},{3},{4},{5})".format(*params)
        cursor = self.Call_Procedure(proc)
