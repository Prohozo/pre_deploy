...
def gen_layout():
    ...
    color = '#FFD45D'
    icon = 'ov_NV.svg'
    layout = create_card(title,'ov-NV',color,icon)
           
    return layout

@app_User.callback(
    Output("ov-NV","children"),
...
def UPDATE_OV_NV(start_date,end_date,ddl_project,ddl_user,ddl_dept,user_opened,user_done,user_project,user_started,user_project_task,ac_project,ac_user,ac_log,ac_project_task,ac_workload,data_project, data_user,data_log,data_project_task,data_workload):
    ...
    df = DB_User.GET_USER(('ov_NV',start_date,end_date,ddl_project,ddl_user,ddl_dept,label,value,None,None,None,None))
