...
#                         html.Div([
#                             html.Div([
#                                 html.Div("BẢNG CHI TIẾT KHÁCH HÀNG THEO LIÊN HỆ VÀ NGUỒN", style={'width':'100%','fontWeight': 'bold','background': '#FF938B'}),
#                                 html.A(
#                                     children=[
#                                         html.I(className="fas fa-file-download")
#                                     ],
#                                     id='download_detail_contact_leadsource',
#                                     download="DETAIL_CONTACT_LEADSOURCE.csv",
#                                     target="_blank",
#                                     href = '',
...
#                     ], className="col-9",style={'height':'100%'})
...
#     Output("contact_leadsource","data"),
...
#     Input('contact_leadsource', 'page_current'),
#     Input('contact_leadsource', 'page_size'),
#     Input('contact_leadsource', 'sort_by'),
#     Input('contact_leadsource', 'filter_query'),
#     ],

# )

# def UPDATE_contact_leadsource(start_date,end_date,ddl_leadsource,ddl_industry,ddl_account,ddl_user_assign,ddl_user_marketing,ddl_user_service,ddl_dept,status,page_current,page_size,sort_by, filter):
#     ctx = dash.callback_context

#     label, value = GParams.Get_Value(ctx)
#     df = DB_Accounts.GET_ACCOUNTS(('contact_leadsource',start_date,end_date,ddl_leadsource,ddl_industry,ddl_account,ddl_user_assign,ddl_user_marketing,ddl_user_service,ddl_dept,None,None,None,None,label,value))
...
# @app_Accounts.callback(
#     Output('download_detail_contact_leadsource', 'href'),
#     [Input('download_detail_contact_leadsource', 'n_clicks'),
#      Input('contact_leadsource', 'data')]
# )
