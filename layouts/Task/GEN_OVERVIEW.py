...
def create_card(title,id,color,icon):
    return  html.Div([
                html.Div([
                    html.Div([
                        html.Div([f'{title}'],style={'color':'#fff','margin-bottom':'10px'},className='title_below'),
                        html.Div([
                            html.Div(className='col-6 value', id=id, style={'color':'#fff','font-size': '30px', 'font-weight': '800'}),
                            html.Div(className='col-6 value', id=id+'_diff', style={'color':'#fff','font-size': '30px', 'font-weight': '300'})
                        ], className='row'),
